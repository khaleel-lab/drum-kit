...
document.addEventListener("keydown", function (event) {
    makeSound(event.key); //read and capture the keyvalues
...
function makeSound(key) {
    ...
    switch (key) {
            ...
            default: console.log(buttonKeyword);
...
//The Named Function will be created to click the drum button

// for (var i = 0; i < noOfDrumButtons; i++) {
//     document.querySelectorAll(".drum")[i].addEventListener("click", handleClick); //for loop will click all drum buttons.
// }
